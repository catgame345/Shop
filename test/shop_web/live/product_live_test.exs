defmodule ShopWeb.ProductLiveTest do
  ...
  @create_attrs %{product: "some product", image: "some image", price: "120.5"}
  @update_attrs %{product: "some updated product", image: "some updated image", price: "456.7"}
  @invalid_attrs %{product: nil, image: nil, price: nil}
  ...
  describe "Index" do
    ...
    test "updates product in listing", %{conn: conn, product: product} do
      ...
      assert html =~ "some updated product"
    end
